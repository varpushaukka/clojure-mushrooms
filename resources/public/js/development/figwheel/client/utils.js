...
return (new CustomEvent(event_name,(function (){var obj23626 = ({"detail":data});
return obj23626;
})()));
} else {
...
var f = (function (){var pred__23633 = cljs.core._EQ_;
var expr__23634 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__23633.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__23634))){
return ((function (pred__23633,expr__23634){
return (function (p1__23627_SHARP_){
return console.warn(p1__23627_SHARP_);
});
;})(pred__23633,expr__23634))
} else {
if(cljs.core.truth_(pred__23633.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__23634))){
return ((function (pred__23633,expr__23634){
return (function (p1__23628_SHARP_){
return console.debug(p1__23628_SHARP_);
});
;})(pred__23633,expr__23634))
} else {
if(cljs.core.truth_(pred__23633.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__23634))){
return ((function (pred__23633,expr__23634){
return (function (p1__23629_SHARP_){
return console.error(p1__23629_SHARP_);
});
;})(pred__23633,expr__23634))
} else {
return ((function (pred__23633,expr__23634){
return (function (p1__23630_SHARP_){
return console.log(p1__23630_SHARP_);
});
;})(pred__23633,expr__23634))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__23637){
...
var opts = map__23638__$1;
var eval_fn = cljs.core.get.call(null,map__23638__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__23640_SHARP_);
});})(new_def))
);
...
return (function (p__23641){
var vec__23642 = p__23641;
var ky = cljs.core.nth.call(null,vec__23642,(0),null);
var v = cljs.core.nth.call(null,vec__23642,(1),null);
...
}catch (e23647){if((e23647 instanceof Error)){
var e = e23647;
return not_found;
} else {
throw e23647;
...
//# sourceMappingURL=utils.js.map?rel=1575893147565
