...
mushrooms.core.run_sketch = (function mushrooms$core$run_sketch(){
mushrooms.core.mushrooms = (function mushrooms$core$run_sketch_$_mushrooms(){
...
:mushrooms.core.update_state),new cljs.core.Keyword(null,"size","size",1098693007),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(500),(500)], null),new cljs.core.Keyword(null,"setup","setup",1987730512),((cljs.core.fn_QMARK_.call(null,mushrooms.core.setup))?(function() { 
...
return quil.sketch.add_sketch_to_init_list.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fn","fn",-1175266204),mushrooms.core.mushrooms,new cljs.core.Keyword(null,"host-id","host-id",742376279),"mushrooms"], null));
}
});
goog.exportSymbol('mushrooms.core.run_sketch', mushrooms.core.run_sketch);
