...
var vec__21323 = axis;
var a_x = cljs.core.nth.call(null,vec__21323,(0),null);
var a_y = cljs.core.nth.call(null,vec__21323,(1),null);
var a_z = cljs.core.nth.call(null,vec__21323,(2),null);
var vec__21326 = v;
var x = cljs.core.nth.call(null,vec__21326,(0),null);
var y = cljs.core.nth.call(null,vec__21326,(1),null);
var z = cljs.core.nth.call(null,vec__21326,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__21329,p__21330){
var vec__21331 = p__21329;
var u1 = cljs.core.nth.call(null,vec__21331,(0),null);
var u2 = cljs.core.nth.call(null,vec__21331,(1),null);
var u3 = cljs.core.nth.call(null,vec__21331,(2),null);
var vec__21334 = p__21330;
var v1 = cljs.core.nth.call(null,vec__21334,(0),null);
var v2 = cljs.core.nth.call(null,vec__21334,(1),null);
var v3 = cljs.core.nth.call(null,vec__21334,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__21337_SHARP_){
return (p1__21337_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__21338_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__21339_SHARP_,angle_lr),angle_ud);
...
var map__21341 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__21341__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__21341__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__21343 = cljs.core._EQ_;
var expr__21344 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__21343.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__21344))){
return straight;
} else {
if(cljs.core.truth_(pred__21343.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__21344))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__21343.call(null,quil.middlewares.navigation_3d.space,expr__21344))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__21343.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__21344))){
return up;
} else {
if(cljs.core.truth_(pred__21343.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__21344))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__21343.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__21344))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__21341,map__21341__$1,up,straight){
return (function (p1__21340_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__21340_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__21341,map__21341__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__21346_SHARP_);
});})(initial_state))
);
});
/**
...
var map__21347_21358 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__21347_21359__$1 = (((((!((map__21347_21358 == null))))?(((((map__21347_21358.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21347_21358.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21347_21358):map__21347_21358);
var vec__21348_21360 = cljs.core.get.call(null,map__21347_21359__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_21361 = cljs.core.nth.call(null,vec__21348_21360,(0),null);
var c_y_21362 = cljs.core.nth.call(null,vec__21348_21360,(1),null);
var c_z_21363 = cljs.core.nth.call(null,vec__21348_21360,(2),null);
var vec__21351_21364 = cljs.core.get.call(null,map__21347_21359__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_21365 = cljs.core.nth.call(null,vec__21351_21364,(0),null);
var u_y_21366 = cljs.core.nth.call(null,vec__21351_21364,(1),null);
var u_z_21367 = cljs.core.nth.call(null,vec__21351_21364,(2),null);
var vec__21354_21368 = cljs.core.get.call(null,map__21347_21359__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_21369 = cljs.core.nth.call(null,vec__21354_21368,(0),null);
var p_y_21370 = cljs.core.nth.call(null,vec__21354_21368,(1),null);
var p_z_21371 = cljs.core.nth.call(null,vec__21354_21368,(2),null);
quil.core.camera.call(null,p_x_21369,p_y_21370,p_z_21371,(p_x_21369 + c_x_21361),(p_y_21370 + c_y_21362),(p_z_21371 + c_z_21363),u_x_21365,u_y_21366,u_z_21367);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1575893144786
